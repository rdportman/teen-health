...
net11_d3 <- igraph_to_networkD3(graph11, group= get.vertex.attribute(graph11, "Race"))
...
fn3 <- forceNetwork(Links = net11_d3$links, Nodes = net11_d3$node,
                    ...
                    opacity = 1,
                    fontSize=24) 
fn3 %>% saveNetwork(file = 'net11R_fn3.html')
